      ...
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          ...
          <p className="py-2 text-gray-600">
            I specialize in building mobile responsive full stack/Frontend UI
            ...
            Javascript, Bootstrap and React, I am a quick learner and can pick
            ...
            the job. I am a MERN full-stack developer.
          </p>
          <p className="py-2 text-gray-600">
            I started web developement in 2022. I have experience working in
            taking mock wireframes all the way to deployed applications.
          </p>
          <Link href="/#projects">
